                                        ...
                                        <template>
                                            <el-card class="box-card">
                                                <div slot="header" class="clearfix">
                                                    <span style="line-height: 24px;">套餐组添加</span>
                                                ...
                                                <el-form label-width="120px" :inline="true">
                                                    <el-form-item label="套餐名称">
                                                        <el-input style="width:100%;" size="small" placeholder="请输入套餐名称" v-model="productForm.itemGname"></el-input>
                                                    </el-form-item>
                                                    ...
                                                    <el-form-item label="套餐商品列表">
                                                        ...
                                                        <el-button class="button-new-tag" size="small" type="primary" @click="getSetmeal()">添加套餐内商品</el-button>
                                                    </el-form-item>
                                                </el-form>
